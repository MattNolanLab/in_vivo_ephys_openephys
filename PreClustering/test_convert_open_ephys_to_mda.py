...
import PreClustering.convert_open_ephys_to_mda
...
def test_pad_event():
    ...
    result = PreClustering.convert_open_ephys_to_mda.pad_event(waveforms, channel, samples_per_spike, event)
...
def test_get_padded_array():
    ...
    result = PreClustering.convert_open_ephys_to_mda.get_padded_array(waveforms, samples_per_spike)
...
def test_get_peak_indices():
    ...
    result = PreClustering.convert_open_ephys_to_mda.get_peak_indices(waveforms, samples_per_spike)
