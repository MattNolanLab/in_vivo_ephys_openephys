function [posx, posy] = remove_jump_pos(posx, posy, post)

max_speed = 2e3; % maximum speed allowed (pixals / s), instantaneous speed data exceeding this speed will cause the offending position data to be thrown out
