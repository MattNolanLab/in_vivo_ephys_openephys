...
from SpikeSorter.MountainSorter import *
...
def get_location_on_server(recording_directory):
    """Read output location in server from the parameter file
    
    Arguments:
        recording_directory {str} -- directory of recording
    
    Returns:
        str -- output location in server
    """
    parameters_path = recording_directory + '/parameters.txt'
    param_file_reader = open(parameters_path, 'r')
    parameters = param_file_reader.readlines()
...
def call_spike_sorting_analysis_scripts(recording_to_sort):
    try:
        ...
        pre_processing(recording_to_sort)
        # sort(recording_to_sort)
        post_processing(recording_to_sort,output_folder)
...
def monitor_to_sort():
    # Monitoring folder and run sorting if data files are found
...
def pre_processing(recording_to_sort):
    print('-------------------------------------------------------------')
    print('Running pre-processing now')
    print('-------------------------------------------------------------')
...
def post_processing(recording_to_sort,output_folder):
    print('-------------------------------------------------------------')
    print('Running post-processing now')
    print('-------------------------------------------------------------')
...
def sort(recording_to_sort):
    sorter = MountainSorter(recording_to_sort+'/Electrophysiology/MountainSort')
    sorter.run()
