...
def analyse_first_and_second_halves(prm, synced_spatial_data, spike_data_in):
    ...
    snippet_data_first = PostSorting.load_snippet_data.get_snippets(spike_data_first, prm, random_snippets=False)
    ...
    PostSorting.post_process_sorted_data.save_data_frames(spike_data_first, synced_spatial_data_first, snippet_data_first, bad_clusters=None)
    ...
    snippet_data_second = PostSorting.load_snippet_data.get_snippets(spike_data_first, prm, random_snippets=False)
    ...
    PostSorting.post_process_sorted_data.save_data_frames(spike_data_second, synced_spatial_data_second, snippet_data_second, bad_clusters=None)
