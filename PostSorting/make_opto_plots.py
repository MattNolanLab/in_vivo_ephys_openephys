...
def plot_waveforms_opto(spike_data, prm):
    if 'opto_snippets' in spike_data:
        ...
        for cluster_index, cluster_id in enumerate(spike_data.cluster_id):
            ...
            for channel in range(4):
                PostSorting.make_plots.plot_spikes_for_channel(grid, highest_value, lowest_value, spike_data, cluster_id, channel, 'opto_snippets')
