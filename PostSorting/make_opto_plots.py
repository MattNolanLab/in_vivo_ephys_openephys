...
def make_peristimulus_histogram_for_cluster(spatial_firing, peristimulus_spikes, cluster, session, light_pulse_duration,
    ...
    salt_p = np.round(spatial_firing[spatial_firing.cluster_id == cluster].SALT_p[0], 4)
    salt_i = np.round(spatial_firing[spatial_firing.cluster_id == cluster].SALT_I[0],4)
