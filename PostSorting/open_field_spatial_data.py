...
def process_position_data(recording_folder, do_resample=False):
    '''
    ...
    if is_found:
        ...
        if do_resample:
            ...
            position_data = resample_position_data(position_data,30, fixna=True) # may be better to interpolate missing values here
    if not is_found:
