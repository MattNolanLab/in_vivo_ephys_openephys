...
def find_first_stop_in_series(processed_position_data):
    ...
    for trial_number in unique_trial_numbers:
        stops = np.array(processed_position_data['stop_location_cm'])[np.array(processed_position_data['stop_trial_number']) == trial_number]
        trial_type =  np.array(processed_position_data['stop_trial_type'])[np.array(processed_position_data['stop_trial_number']) == trial_number][0]
