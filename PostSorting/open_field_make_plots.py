...
def plot_polar_head_direction_histogram(hd_hist, spatial_firing, prm):
    ...
    for cluster in range(len(spatial_firing)):
        ...
        plt.title('max fr: ' + str(round(spatial_firing.max_firing_rate_hd[cluster], 2)) + ' Hz' + ', preferred HD: ' + str(round(spatial_firing.preferred_HD[cluster][0], 0)) + ' hd score: ' + str(round(spatial_firing.hd_score[cluster][0], 2)), y=1.08)
