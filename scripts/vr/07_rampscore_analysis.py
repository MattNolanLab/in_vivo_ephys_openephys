...
if data:
    ...
    pos_binned = np.argmax(pos_grid,axis=1)*(settings.trackLength/settings.position_bin)
    pos_bins = np.arange(settings.trackLength, step=settings.trackLength/settings.position_bin).astype(int)
