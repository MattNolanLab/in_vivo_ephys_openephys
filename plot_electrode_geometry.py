...
def test_probe_interface(save_path):
    ...
    plt.savefig("/mnt/datastore/Harry/test_recording/probe_locations_"+str(64)+"_channels.png", dpi=600)
    plt.close()
    ...
    fig = plt.figure(figsize=(6,6))
    ax = fig.add_subplot(1, 1, 1)
    plot_probe(recording_probes.get_probe(), ax=ax, with_device_index=True)
    plt.savefig("/mnt/datastore/Harry/test_recording/probe_locations_"+str(64)+"_channels_plus_channel_indices.png", dpi=600)
    plt.close()
...
def test_double_probe_interface(save_path):
    ...
    fig = plt.figure(figsize=(6,6))
    ax = fig.add_subplot(1, 1, 1)
    plot_probe_group(recording_probes.get_probegroup(), ax=ax, with_channel_index=True, with_device_index=True)
    plt.savefig("/mnt/datastore/Harry/test_recording/probe_locations_"+str(128)+"_channels.png", dpi=600)
    plt.close()
